...
```bash
uv run ${CLAUDE_PLUGIN_ROOT}/skills/prp-core/prp-worktree/scripts/worktree.py create <name> [--base <branch>]
uv run ${CLAUDE_PLUGIN_ROOT}/skills/prp-core/prp-worktree/scripts/worktree.py list [--base <branch>] [--json]
uv run ${CLAUDE_PLUGIN_ROOT}/skills/prp-core/prp-worktree/scripts/worktree.py remove <name> [--force] [--delete-branch]
```
